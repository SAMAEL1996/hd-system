...
class GoogleDriveApi {
    ...
    public function UploadFileToDrive ($access_token, $file_content, $mime_type) {
        $apiURI = self::DRIVE_FILE_UPLOAD_URI . '?uploadType=media';
        $ch = curl_init();
    ...
    public function UpdateFileMeta($access_token, $file_id, $file_metadata) {
        ...
        curl_setopt($ch, CURLOPT_CUSTOMREQUESTS, 'PATCH');
